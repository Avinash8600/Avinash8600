...
### 🚀 Cloud-Native Deployment on Kubernetes (AWS EC2)
- 🐳 Built and deployed containerized application using **Docker**
- ☸️ Managed workloads using **Kubernetes (Kind multi-node cluster)**
- ⚙️ Configured **Deployments, Services, Namespaces**
- 🌐 Exposed application using **NodePort**
- 📈 Designed for **scalability & high availability**
- 🔍 Performed **debugging, monitoring & troubleshooting**
...
<p align="center">
  <img src="https://github-readme-stats-git-masterrstaa-rickstaa.vercel.app/api/top-langs/?username=Avinash8600&layout=compact&theme=tokyonight" />
</p>
...
## ⚡ DevOps Mindset
💡 *“Automate everything, monitor continuously, and scale efficiently.”*
